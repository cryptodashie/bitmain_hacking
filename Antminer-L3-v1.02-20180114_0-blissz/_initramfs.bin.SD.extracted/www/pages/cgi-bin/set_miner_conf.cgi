...
do
	...
	;;
        ...
        ;;
	21 )
        ant_freq4=${ant_var/_ant_freq4=/}
        ;;
        22 )
        ant_voltage4=${ant_var/_ant_voltage4=/}
        ;;
        23 )
	...
	24 )
        ...
        ;;
        25 )
        ant_daily_fee=${ant_var/_ant_daily_fee=/}
        ;;
	esac
	i=`expr $i + 1`
done
...
if [ "${ant_daily_fee}" = "true" ]; then
        echo "\"bitmain-daily-fee\" : "true","                                >> /config/cgminer.conf
fi
...
echo "\"bitmain-freq4\" : \"${ant_freq4}\","                            >> /config/cgminer.conf
echo "\"bitmain-voltage4\" : \"${ant_voltage4}\""                               >> /config/cgminer.conf
echo "}"								>> /config/cgminer.conf
sync &
sleep 1s
