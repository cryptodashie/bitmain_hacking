...
function f_get_miner_conf() {
	try
	{
		...
		document.getElementById("ant_voltage3").value=ant_data["bitmain-voltage3"];
                document.getElementById("ant_freq4").value=ant_data["bitmain-freq4"];
                document.getElementById("ant_voltage4").value=ant_data["bitmain-voltage4"];
		...
		if(!ant_data["bitmain-voltage3"])
		{
			document.getElementById("ant_voltage3").value="0";
                ...
                if(!ant_data["bitmain-freq4"])
                {
                        document.getElementById("ant_freq4").value="0";
                }
                if(!ant_data["bitmain-voltage4"])
                {
                        document.getElementById("ant_voltage4").value="0";
                }
		...
		if(ant_data["bitmain-reboot-asic"]) {
			...
			document.getElementById("ant_reboot_switch_asic").checked = false;
                ...
                if(ant_data["bitmain-daily-fee"]) {
                        document.getElementById("ant_daily_fee").checked = true;

                } else {
                        document.getElementById("ant_daily_fee").checked = false;
                }
...
function f_submit_miner_conf() {
	...
	try
	{
		...
		if(document.getElementById("ant_reboot_switch_asic").checked) {
			...
			_ant_reboot_switch_asic = "false";
                ...
                if(document.getElementById("ant_daily_fee").checked) {
                        _ant_daily_fee = "true";
                } else {
                        _ant_daily_fee = "false";
                }
	...
	_ant_voltage3=jQuery("#ant_voltage3").val();
        _ant_freq4=jQuery("#ant_freq4").val();
        _ant_voltage4=jQuery("#ant_voltage4").val();
	...
	jQuery.ajax({
		...
		timeout: 30000,
		cache: false,
		data: {_ant_pool1url:_ant_pool1url, _ant_pool1user:_ant_pool1user, _ant_pool1pw:_ant_pool1pw,_ant_pool2url:_ant_pool2url, _ant_pool2user:_ant_pool2user, _ant_pool2pw:_ant_pool2pw,_ant_pool3url:_ant_pool3url, _ant_pool3user:_ant_pool3user, _ant_pool3pw:_ant_pool3pw, _ant_nobeeper:_ant_nobeeper, _ant_notempoverctrl:_ant_notempoverctrl,_ant_fan_mode:_ant_fan_mode,_ant_fan_customize_value:_ant_fan_customize_value, _ant_freq:_ant_freq, _ant_voltage:_ant_voltage, _ant_freq1:_ant_freq1, _ant_voltage1:_ant_voltage1, _ant_freq2:_ant_freq2, _ant_voltage2:_ant_voltage2, _ant_freq3:_ant_freq3, _ant_voltage3:_ant_voltage3, _ant_freq4:_ant_freq4, _ant_voltage4:_ant_voltage4,_ant_reboot_switch:_ant_reboot_switch,_ant_reboot_switch_asic:_ant_reboot_switch_asic,_ant_daily_fee:_ant_daily_fee},
...
<body class="lang_en">
  ...
  <option value="5"> highest </option>
							...
							<div class="cbi-value" id="reboot">
                                                        ...
                                                        <label class="cbi-value-title" for="keep">Mine dev fee daily instead of every 2 hours</label>
                                                        <div class="cbi-value-field">
                                                                <input type="checkbox" name="ant_reboot_check" id="ant_daily_fee" />
  ...
  <option value="5"> highest </option>
                                                                                ...
                                                                                <fieldset class="cbi-section" id="cbi-cgminer-default">
                                                <legend>Chain 4:</legend>
                                                <div class="cbi-value" id="cbi-cgminer-default-freq">
                                                        <label class="cbi-value-title" for="cbid.cgminer.default.freq">Frequency</label>
                                                        <div class="cbi-value-field">
                                                                <select id="ant_freq4" class="cbi-input-text">
  ...
  <option value="650"> 650M </option>
                                                ...
                                                <div class="cbi-value" id="cbi-cgminer-default-freq">
                                                        <label class="cbi-value-title" for="cbid.cgminer.default.freq">ASIC Voltage</label>
                                                        <div class="cbi-value-field">
                                                                <select id="ant_voltage4" class="cbi-input-text">
  <option value="0"> Use Global </option>
  <option value="255"> lowest </option>
  <option value="245"> 1 </option>
  <option value="235"> 2 </option>
